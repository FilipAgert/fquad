program main
    ...
    if(arg1 == "leg") then
        ...
        write(*,'(A25,E45.32)') "Analytical solution: I = ", atan(5.0_r_kind)*2.0_r_kind/5
        write(*,'(A25,E45.32)') "Quadrature solution: I = ", sum(weights/(1.0_r_kind+25.0_r_kind*roots**2),1)
    else if(arg1 == "lag") then
